...
public class CollegeManagementApp {
	...
	int selectOption;
	long collegeCode;
	int rollNo,attendancePercentage;
	long feesPaid;
	...
	public CollegeManagementApp(String adminName, String adminPassword, String userName1, String userPassword1,
			String userName2, String userPassword2, int selectOption, long collegeCode, int rollNo,
			int attendancePercentage, long feesPaid) {
		super();
	...
	public String toString() {
		return "CollegeManagementApp [adminName=" + adminName + ", adminPassword=" + adminPassword + ", userName1="
				...
				+ rollNo + ", attendancePercentage=" + attendancePercentage + ", feesPaid=" + feesPaid + "]";
	}
